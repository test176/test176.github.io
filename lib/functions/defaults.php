...
function complete_option_defaults() {
	$defaults = array(
		...
		'totop_id' => '1',
		'footer_text_id' => __('&copy; Copyright 2019. SKT Ebook. All Rights Reserved. Designed by SKT Themes', 'complete'),
		...
		'slide_overlay_image' => ''.get_template_directory_uri().'/images/book-img.png',
        ...
        'slide_title1' => '<small>Buy your favourite</small>eBooks here',
        'slide_desc1' => 'Tristique nec ipsum. Ut quis ornare eratduis et urna sit amet nulla one venenatis.',
        'slide_link1' => '#',
        'slide_btn1' => 'Buy Now',
		...
		'mobbgtop_color_id' => '#ffb000',
		'mobmenutxt_color_id' => '#ffffff',
		'mobmenutxt_active_color_id' => '#ffb000',
		
		'mobtoggle_color_id' => '#ffb000',
		...
		'logo_image_height' => '36px;',
		'logo_image_width' => '163px;',
		...
		'testimonial_activepager_color_id' => '#ffb000',
		...
		'perfect_hover_border_color' => '#ffb000',
		...
		'footer_title_border_color' => '#ffb000',
		...
		'txt_upcase_id' => '',
		'mnutxt_upcase_id' => '0',
		'copyright_bg_color' => 'transparent',
		...
		'featured_block_button_bg' => '#ffb000',
		'featured_block_hover_button_bg' => '#393939',
		
		//Footer Column 1
		'foot_cols1_title' => __('ABOUT EBOOK', 'complete'),
