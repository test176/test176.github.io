...
// Slide Overlay Image
	$wp_customize->add_setting( 'complete[slide_overlay_image]',array( 
		'type' => 'option',
		'default' => ''.get_template_directory_uri().'/images/book-img.png',
		'sanitize_callback' => 'esc_url_raw',
		)
	);
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'slide_overlay_image',array(
			'label'       => __( 'Slide Overlay Image', 'complete' ),
			'section'     => 'slider_section',
			'settings'    => 'complete[slide_overlay_image]'
				)
			)
	);
...
// Slide Font Typography And Colors
	...
	$wp_customize->add_setting('complete[slide_title1]', array(
		'type' => 'option',
		'default'	=> __('<small>Buy your favourite</small>eBooks here','complete'),
	...
	$wp_customize->add_setting('complete[slide_desc1]', array(
		'type' => 'option',
		'default'	=> __('Tristique nec ipsum. Ut quis ornare eratduis et urna sit amet nulla one venenatis.','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
	...
	$wp_customize->add_setting('complete[slide_btn2]', array(
		'type' => 'option',
		'default'	=> __('BOOK APPOINTMENT','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
