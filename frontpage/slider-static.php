  ...
  <div class="slider-main">
    ...
    <div class="slider-wrapper slide-temp theme-default">
      ...
      <div id="htmlcaption" class="nivo-html-caption">
        <div class="title"><?php echo 'SKT Ele Ebook Lite<small>Portfolio</small>Theme'; ?></div>
    ...
    <div class="slide-overlay-image"><img src="<?php echo $complete['slide_overlay_image']; ?>" /></div>
